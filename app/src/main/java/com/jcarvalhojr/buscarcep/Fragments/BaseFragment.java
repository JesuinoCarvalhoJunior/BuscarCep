...
import com.jcarvalhojr.buscarcep.TaskService.TaskListener;
import com.jcarvalhojr.buscarcep.TaskService.TaskResult;
...
public abstract class BaseFragment extends DebugFragment {
    ...
    private String TAG = "LogBaseFragment";
